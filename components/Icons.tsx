...
export const ArrowTrendingUpIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22m0 0l-3.75-.625m3.75.625V3.375" /></svg>
);
...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.898 20.553L16.5 21.75l-.398-1.197a3.375 3.375 0 00-2.9-2.9l-1.197-.398 1.197-.398a3.375 3.375 0 002.9-2.9l.398-1.197.398 1.197a3.375 3.375 0 002.9 2.9l1.197.398-1.197.398a3.375 3.375 0 00-2.9 2.9z" /></svg>
);
...
export const FlaskIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75h7.5M8.25 10.5h7.5M8.25 14.25h7.5M4.861 20.131A8.25 8.25 0 0012 21.75c2.276 0 4.347-.86 5.928-2.275M15.75 9.75c0-1.849-1.253-3.435-3-4.006M15.75 9.75c.018.134.03.27.03.412a8.25 8.25 0 01-16.5 0c0-.142.012-.278.03-.412M15.75 9.75L12 3.75m0 0L8.25 9.75M12 3.75v6" /></svg>
);
...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <defs>
            ...
            <stop offset="0%" style={{stopColor: '#4A5C50'}} />
            <stop offset="100%" style={{stopColor: '#D4A22E'}} />
            </linearGradient>
        </defs>
        <path fill="url(#logo-gradient)" d="M50 0 C 40 20, 20 20, 10 50 C 20 80, 40 80, 50 100 C 60 80, 80 80, 90 50 C 80 20, 60 20, 50 0 Z M 50 20 C 55 40, 65 40, 70 50 C 65 60, 55 60, 50 80 C 45 60, 35 60, 30 50 C 35 40, 45 40, 50 20 Z" />
    </svg>
);


export const WifiIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M8.288 15.038a5.25 5.25 0 017.424 0M5.106 11.856c3.807-3.808 9.98-3.808 13.788 0M1.924 8.674c5.565-5.565 14.587-5.565 20.152 0M12.75 18.462a.75.75 0 10-1.5 0 .75.75 0 001.5 0z" /></svg>
);

export const BeakerIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c.102.02.206.032.314.032.108 0 .212-.012.314-.032M9.75 3.104L12 2.25l2.25.854M12 21.75a2.625 2.625 0 100-5.25 2.625 2.625 0 000 5.25zM14.25 11.659v5.714a2.25 2.25 0 00.659 1.591L19 14.5M14.25 11.659c-.102.02-.206.032-.314.032-.108 0-.212-.012-.314-.032" /></svg>
);

export const ClipboardDocumentListIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.156.812.426 1.126m5.801 0V9.117A2.25 2.25 0 0115.334 11.4a48.51 48.51 0 00-2.33 0 2.25 2.25 0 01-2.116-2.283V3.913a2.25 2.25 0 012.25-2.25h2.25M6.75 15h.008v.008H6.75V15zm0 2.25h.008v.008H6.75v-.008zm0 2.25h.008v.008H6.75v-.008z" /></svg>
);
...
export const ArrowTrendingDownIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6L9 12.75l4.286-4.286a11.948 11.948 0 014.306 6.43l.776 2.898m0 0l3.182-5.511m-3.182 5.51l-5.511-3.181" /></svg>
);
...
export const CloudIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15a4.5 4.5 0 004.5 4.5H18a3.75 3.75 0 001.332-7.257 3 3 0 00-3.758-3.848 5.25 5.25 0 00-9.752 1.583A5.25 5.25 0 002.25 15z" /></svg>
);

export const CloudRainIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 13.5L19.5 9.75c0-4.25-3-7.5-7.5-7.5s-7.5 3.25-7.5 7.5v3.75m15 0c1.25 0 2.25.75 2.25 2.25s-1 2.25-2.25 2.25h-15c-1.25 0-2.25-1-2.25-2.25s1-2.25 2.25-2.25m15 0h-15M12 15.75v3.75" /></svg>
);
...
export const ArrowLeftOnRectangleIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m3 0l-3-3m0 0l-3 3m3-3V12" /></svg>
);
...
export const MicrophoneIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 006-6v-1.5m-6 7.5a6 6 0 01-6-6v-1.5m6 7.5v3.75m-3.75 0h7.5M12 15.75a3 3 0 01-3-3V4.5a3 3 0 013-3a3 3 0 013 3v8.25a3 3 0 01-3 3z" /></svg>
);
...
export const DropletIcon: React.FC<IconProps> = ({ className, style }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} style={style}><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 13.5L19.5 9.75c0-4.25-3-7.5-7.5-7.5s-7.5 3.25-7.5 7.5v3.75m15 0c1.25 0 2.25.75 2.25 2.25s-1 2.25-2.25 2.25h-15c-1.25 0-2.25-1-2.25-2.25s1-2.25 2.25-2.25m15 0h-15" /></svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.372c-1.034.103-1.933-.35-2.5-1.121l-3.722-4.652c-.62-.773-1.635-1.16-2.64-1.038l-1.03.103c-.924.092-1.688-.585-1.688-1.464v-4.286c0-1.282 1.046-2.328 2.328-2.328h9.916c.338 0 .66.059.967.168.253.09.49.215.704.362L20.25 8.511zM10.5 14.25L12 12m0 0l1.5-2.25M12 12l-1.5-2.25M12 12l1.5 2.25M12 12l-1.5 2.25" /></svg>
);

export const Cog6ToothIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15 0a7.5 7.5 0 1115 0m-15 0H3m15 0h-1.5m-12 5.25v-1.5m1.5 1.5v-1.5m3-3v-1.5m1.5 1.5v-1.5m3 3v-1.5m1.5 1.5v-1.5M12 6.75v-1.5m-3 3v-1.5m-1.5-1.5v-1.5m3-1.5v-1.5m1.5 1.5v-1.5m3 3v-1.5m1.5 1.5v-1.5" /></svg>
);
